...
- [`plot_location_funding_destination()`](plot_location_funding_destination.md)
  : Plot Funding by Destination Location
- [`plot_location_funding_donor()`](plot_location_funding_donor.md) :
  Plot Destination Funding by Donor
- [`plot_location_heatmap()`](plot_location_heatmap.md) : Plot Top
  Donors Heatmap
